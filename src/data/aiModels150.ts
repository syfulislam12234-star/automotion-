...
const MODEL_IDS = [
  ...
  'pollinations/openai', 'pollinations/mistral', 'pollinations/llama', 'pollinations/searchgpt', 'pollinations/qwen-coder', 'pollinations/deepseek', 'pollinations/llama-3.3', 'pollinations/gemma', 'pollinations/command-r', 'pollinations/phi-4',
