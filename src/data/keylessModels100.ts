...
export const KEYLESS_PROBE_ROUTES: KeylessProbeRoute[] = [
  ...
  { name: 'NVIDIA Nemotron 4 340B (Free)', provider: 'openrouter', probeUrl: 'https://openrouter.ai/api/v1/models', modelId: 'nvidia/nemotron-4-340b-instruct:free' },
  { name: 'Qwen 2.5 7B (Free)', provider: 'openrouter', probeUrl: 'https://openrouter.ai/api/v1/models', modelId: 'qwen/qwen-2.5-7b-instruct:free' },
  { name: 'Nous Hermes 2 Mixtral (Free)', provider: 'openrouter', probeUrl: 'https://openrouter.ai/api/v1/models', modelId: 'nousresearch/nous-hermes-2-mixtral-8x7b-dpo:free' },
  { name: 'OpenChat 3.5 (Free)', provider: 'openrouter', probeUrl: 'https://openrouter.ai/api/v1/models', modelId: 'openchat/openchat-7b:free' },
  { name: 'MythoMax 13B (Free)', provider: 'openrouter', probeUrl: 'https://openrouter.ai/api/v1/models', modelId: 'gryphe/mythomax-l2-13b:free' },
  { name: 'Yi 1.5 34B (Free)', provider: 'openrouter', probeUrl: 'https://openrouter.ai/api/v1/models', modelId: '01-ai/yi-1.5-34b-chat:free' },
  { name: 'WizardLM 2 8x22B (Free)', provider: 'openrouter', probeUrl: 'https://openrouter.ai/api/v1/models', modelId: 'microsoft/wizardlm-2-8x22b:free' },
  { name: 'Phi-3 Medium (Free)', provider: 'openrouter', probeUrl: 'https://openrouter.ai/api/v1/models', modelId: 'microsoft/phi-3-medium-128k-instruct:free' },
  { name: 'Zephyr 7B (Free)', provider: 'openrouter', probeUrl: 'https://openrouter.ai/api/v1/models', modelId: 'huggingfaceh4/zephyr-7b-beta:free' },
  { name: 'Llama 3 8B (Free)', provider: 'openrouter', probeUrl: 'https://openrouter.ai/api/v1/models', modelId: 'meta-llama/llama-3-8b-instruct:free' },
