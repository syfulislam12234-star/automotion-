...
export const SubscriptionModal: React.FC<SubscriptionModalProps> = ({
  ...
  const plans = [
    ...
    },
    {
      ...
      price: '$29',
      period: '/mo',
      description: '150-AI Failover Cascade, 10-Channel Gateways, and AI SEO YouTube Studio.',
      features: ['150-AI Redundancy Cascade', '10 Omni-Channel Gateways', 'Unlimited sliding memory', 'YouTube AI Auto-SEO & Scheduler', 'Sub-second LPU streaming'],
      highlight: true,
      active: false,
    },
    {
